...
// eslint-disable-next-line camelcase
externals['@grpc/grpc-js'] = 'next/dist/compiled/@grpc/grpc-js'
export async function ncc_grpc_js(task, opts) {
  await task
    .source(opts.src || relative(__dirname, require.resolve('@grpc/grpc-js')))
    .ncc({ packageName: '@grpc/grpc-js', externals })
    .target('compiled/@grpc/grpc-js')
}
