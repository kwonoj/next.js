...
/**
 * Options to create exporter to collector using otlp-http.
 * Most of configurations can be controlled via environment variables as well -
 * refer
 * https://github.com/open-telemetry/opentelemetry-js/blob/bd9159a35331406cbbd790c0d4542b1cebf3b442/experimental/packages/exporter-trace-otlp-http/README.md#configuration-options-as-environment-variables
 * for more details.
 *
